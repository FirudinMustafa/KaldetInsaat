...
export default function NewServicePage() {
  ...
  const [processes, setProcesses] = useState<Array<{ title: string; description: string }>>([])
  const [materials, setMaterials] = useState<Array<{ name: string; description: string }>>([])
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Yeni bir hizmet ekleyin</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                {isSubmitting ? "Kaydediliyor..." : "Hizmeti Kaydet"}
              </Button>
