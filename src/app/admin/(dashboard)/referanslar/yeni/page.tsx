  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Yeni Referans</h1>
          <p className="text-gray-500 mt-1">Yeni bir müşteri referansı ekleyin</p>
        </div>
      </div>
